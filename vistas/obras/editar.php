...
$capataces = $obra->obtenerCapatacesDisponiblesParaEditar(
    $obraEditar["id_obra"]
);
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                >
                    ...
                    <?php foreach ($capataces as $capataz) { ?>
                        ...
                        <option
                            value="<?= $capataz["id_usuario"] ?>"
                            <?= $obraEditar["id_capataz"] == $capataz["id_usuario"] ? "selected" : "" ?>
                        >
            ...
            <div class="form-group form-group-full">
                ...
                <textarea
                    ...
                    class="textarea"
                    rows="4"
                ><?= htmlspecialchars($obraEditar["descripcion"]) ?></textarea>
